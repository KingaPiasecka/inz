...
public class PM10MapInterface implements MapInterface {

    private final Context context;

    public PM10MapInterface(Context context) {
        this.context = context;
    }

    @Override
    public MarkerOptions getMeasurementMarker(Dust dust) {
        BitmapDescriptor bitmapDescriptor = getMeasurementDescriptor(dust.getPm10());
